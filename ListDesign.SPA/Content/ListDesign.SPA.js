...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,List,UI,Next,Doc,AttrProxy,Arrays;
 Runtime.Define(Global,{
  ListDesign:{
   SPA:{
    Client:{
     main:function()
     {
      var Body,attrs,attrs1;
      Body=List.ofArray([Doc.TextNode("Hello world")]);
      attrs=[AttrProxy.Create("lang","en")];
      attrs1=[];
      return Doc.RunById("main",Doc.Concat([Doc.Element("html",attrs,[Doc.TextNode("\n"),Doc.Element("head",attrs1,[Doc.TextNode("\n    "),Doc.Element("title",[],[Doc.TextNode("Expenses")]),Doc.TextNode("\n    "),Doc.Element("meta",[AttrProxy.Create("charset","utf-8")],[]),Doc.TextNode("\n    "),Doc.Element("meta",[AttrProxy.Create("name","viewport"),AttrProxy.Create("content","width=device-width, initial-scale=1.0")],[]),Doc.TextNode("\n    "),Doc.Element("link",[AttrProxy.Create("rel","stylesheet"),AttrProxy.Create("type","text/css"),AttrProxy.Create("href","Content/ListDesign.SPA.css")],[]),Doc.TextNode("\n    "),Doc.Element("script",[AttrProxy.Create("type","text/javascript"),AttrProxy.Create("src","Content/ListDesign.SPA.head.js")],[]),Doc.TextNode("\n")]),Doc.TextNode("\n"),Doc.Element("body",[],[Doc.TextNode("\n    "),Doc.Element("div",[],Arrays.ofSeq(Body)),Doc.TextNode("\n    "),Doc.Element("script",[AttrProxy.Create("type","text/javascript"),AttrProxy.Create("src","Content/ListDesign.SPA.min.js")],[]),Doc.TextNode("\n")]),Doc.TextNode("\n")])]));
     }
    }
   }
  }
